...
public class Constants {
    ...
    public static final String BUTTON_PARTNERSHIP = "Partnership";
    public static final String BUTTON_RELATED_PROJECTS = "Related projects";
    public static final String BUTTON_CONTACTS = "Contacts";
